...
def main():
    ...
    print(f"Weighted Validation Accuracy: {val_acc:.4f}")
    ...
    with open("resnetclassification_report.txt", "w") as f:
        f.write(report)

                                          
    np.save("resnetconfusion_matrix.npy", cm)
    ...
    plt.savefig("resnetconfusion_matrix.png")
    plt.close()
