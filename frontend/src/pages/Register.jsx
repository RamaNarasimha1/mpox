...
import { Eye, EyeOff, Lock, Mail, User, Scan } from 'lucide-react';
...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(`Welcome to DermaVision AI, ${user.name}! 🎉`);
      navigate('/dashboard');
    } catch (error) {
      ...
      >
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">DermaVision AI</h1>
        ...
        <p className="text-center text-white text-sm mt-6">
          © 2024 DermaVision AI. All rights reserved.
        </p>
      </motion.div>
    </div>
  );
