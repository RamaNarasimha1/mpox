...
def main():
    ...
    best_val_acc = 0.0
    epochs_no_improve = 0
    best_model_path = "best_mobilenetv3_large.pth"
    ...
    with open("mobileclassification_report.txt", "w") as f:
        f.write(report)

    np.save("mobileconfusion_matrix.npy", cm)
    ...
    plt.savefig("mobileconfusion_matrix.png")
    plt.close()
